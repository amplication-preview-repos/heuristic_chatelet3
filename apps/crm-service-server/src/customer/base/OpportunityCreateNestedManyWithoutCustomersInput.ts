...
@InputType()
class OpportunityCreateNestedManyWithoutCustomersInput {
...
export { OpportunityCreateNestedManyWithoutCustomersInput as OpportunityCreateNestedManyWithoutCustomersInput };
